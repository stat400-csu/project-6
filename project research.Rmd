...
option_mean_75
option_sd_75
dates = c("6/21", "9/21", "12/21", "3/22", "6/22", "12/22", "6/23", "12/23", "06/24")

df_25 <- data.frame(Quarters = dates, Option_values=option_mean_25, Standard_deviation=option_sd_25)
df_25

df_50 <- data.frame(Quarters = dates, Option_values=option_mean_50, Standard_deviation=option_sd_50)
df_50

df_75 <- data.frame(Quarters = dates, Option_values=option_mean_75,Standard_deviation=option_sd_75)
df_75
