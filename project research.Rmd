...
df_25 <- data.frame(Option_values=option_mean_25, Standard_deviation=option_sd_25)
df_25

df_50 <- data.frame(Option_values=option_mean_50, Standard_deviation=option_sd_50)
df_50

df_75 <- data.frame(Option_values=option_mean_75,Standard_deviation=option_sd_75)
df_75
