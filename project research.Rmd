...
ggplot(df_75, aes(x=Periods_till_maturity, y=Option_values)) + 
  geom_point()+
...
ggplot(df_50, aes(x=Periods_till_maturity, y=Option_values)) + 
  geom_point()+
  xlab("Number of periods to maturity")+
  ylab("Option values by Crude Monte Carlo")+
...
ggplot(df_25, aes(x=Periods_till_maturity, y=Option_values)) + 
  geom_point()+
  xlab("Number of periods to maturity")+
  ylab("Option values by Crude Monte Carlo")+
